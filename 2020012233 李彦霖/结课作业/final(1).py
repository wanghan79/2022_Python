...
argument = {"num":1314520,"struct":{"bool":{"num":2}}}
# argument = {"num":1314, "struct":{"int":{"range":(10,20)}, "float":{"range":(100,200)}, "str":{"range":string.ascii_uppercase, "length":10}, "bool":{"num":2}}}
