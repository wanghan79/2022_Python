...
Introduction:
           A function for generate some random numbers or strings and calculate ACC and MCC,It is implemented using iterator.
...
@struct("MCC")
@struct("ACC")
def Random_Generator_Function(**kwargs):
    randoms = structDataSampling(**kwargs)
    result = []
